...
/**
 * Rule that executes for set optional query fields "prefixes", "classes", "uris", "content" (score)
 * and "content" (emptyResults).
 */
public class PrefixesClassesUrisScoreResultsSuggestRule extends SuggestRule {
	 ...
	 */
	public PrefixesClassesUrisScoreResultsSuggestRule(FuzzyQuerySuggester fuzzyQuerySuggester) {
